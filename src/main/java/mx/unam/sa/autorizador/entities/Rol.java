...
public  class Rol implements Serializable {
    ...
    public Rol(Integer idRol, String rol, String descripcion, String tipo, String ipReg, String rfcReg, int status, SistEstrategico sistema) {
        this.idRol = idRol;
        this.rol = rol;
    ...
    public String toString() {
        return "Rol{" + "idRol=" + idRol + ", rol=" + rol + ", descripcion=" + descripcion + ", tipo=" + tipo + ", "
                + "ipReg=" + ipReg + ", rfcReg=" + rfcReg + ", fecReg=" + fecReg + ", status=" + status + '}';
    }
